...
function draw() {
  ...
  // map the centroid value to a usable range for position
  centroid = map(centroid, 40, 10000, height, 0); //map centroid values to usable range
  text(trebleEnergy, width/2, 20); //finding range of values from centroid so that we can map them correctly
